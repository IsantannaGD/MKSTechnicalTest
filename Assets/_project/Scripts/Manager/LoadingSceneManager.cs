...
public class LoadingSceneManager : MonoBehaviour
{
    ...
    [SerializeField] private float _juicesLoadingBarSpeed;
    ...
    private IEnumerator LoadingCoroutine()
    {
        ...
        fillBarSequence.Append(_loadingBarRed.DOFillAmount(1f, _juicesLoadingBarSpeed).OnComplete(() =>
        {
            _phraseTipsIndex++;
            _tips.text = _phraseTips[_phraseTipsIndex];
        }));
        fillBarSequence.Append(_loadingBarBlue.DOFillAmount(1f, _juicesLoadingBarSpeed).OnComplete(() =>
        {
            _phraseTipsIndex++;
            _tips.text = _phraseTips[_phraseTipsIndex];
        }));
        fillBarSequence.Append(_loadingBarGreen.DOFillAmount(1f, _juicesLoadingBarSpeed).OnComplete(() =>
        {
